...
class Generate(commands.GroupCog, group_name = "generate"):
    def __init__(self, bot : commands.Bot):
        super().__init__()
        self.bot = bot
        self.base = r"https://boredhumans.com"
    ...
    async def _gen_waifu(self, interaction : discord.Interaction):
        ...
        req = requests.get(f"{self.base}/anime_images.php")
        ...
        for img in images:
            if "anime" in img["src"]:
                result.set_image(url=rf"{self.base+img['src']}")
                break
        print(result.image)
    ...
    async def _gen_quote(self, interaction : discord.Interaction):
        ...
        for img in images:
            if "quote" in img["src"]:
                result.set_image(url=self.base+img["src"])
                break
